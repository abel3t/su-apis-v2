...
let Student = class Student extends base_entity_1.BaseEntity {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String }, classroomId: { required: true, type: () => String }, order: { required: true, type: () => Number }, phone: { required: false, type: () => String } };
    }
};
__decorate([
...
], Student.prototype, "order", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'varchar', width: 256, nullable: true }),
    __metadata("design:type", String)
...
], Student.prototype, "init", null);
__decorate([
    (0, typeorm_1.BeforeUpdate)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], Student.prototype, "update", null);
Student = __decorate([
