...
let ProductService = class ProductService {
    ...
    updateProduct({ userId, productId, productDto }) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.productRepository.findOneAndUpdate({ _id: (0, utils_1.toObjectId)(productId), isActive: true }, {
                $set: Object.assign({ updatedBy: userId, updatedAt: (0, utils_1.unixTime)() }, productDto)
            });
            return true;
        });
    }
    deleteProduct(productId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.productRepository.deleteOne({ _id: (0, utils_1.toObjectId)(productId) });
            return true;
        });
    }
    addProductCategory(userId, { productId, categoryId }) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.productRepository.findOneAndUpdate({
                _id: (0, utils_1.toObjectId)(productId)
            }, {
                $push: {
                    categories: {
                        categoryId,
