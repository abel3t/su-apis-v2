...
__decorate([
    ...
    (0, common_1.UseGuards)(new auth_guard_1.AuthGuard('jwt'), roles_guard_1.RolesGuard),
...
__decorate([
    (0, common_1.Put)(':productId/categories/:categoryId'),
    (0, roles_decorator_1.Roles)(constant_1.Role.ADMIN),
    (0, common_1.UseGuards)(new auth_guard_1.AuthGuard('jwt'), roles_guard_1.RolesGuard),
    (0, swagger_1.ApiBearerAuth)(),
    openapi.ApiResponse({ status: 200, type: Object }),
...
__decorate([
    (0, common_1.Delete)(':productId/categories/:categoryId'),
    (0, roles_decorator_1.Roles)(constant_1.Role.ADMIN),
    (0, common_1.UseGuards)(new auth_guard_1.AuthGuard('jwt'), roles_guard_1.RolesGuard),
    (0, swagger_1.ApiBearerAuth)(),
    openapi.ApiResponse({ status: 200, type: Object }),
...
__decorate([
    ...
    openapi.ApiResponse({ status: 200, type: Object }),
    __param(0, (0, paging_decorator_1.PaginationParams)({ maxLimit: constant_1.DEFAULT_MAX_LIMIT })),
    __metadata("design:type", Function),
