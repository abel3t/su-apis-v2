...
let CategoryService = class CategoryService {
    ...
    updateCategory({ userId, categoryId, categoryDto }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.categoryRepository.update({ _id: (0, mongodb_1.ObjectID)(categoryId), isActive: true }, Object.assign({ updatedBy: userId, updatedAt: (0, utils_1.unixTime)() }, categoryDto));
            return true;
        });
    }
    deleteCategory(userId, categoryId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.categoryRepository.delete({ _id: (0, utils_1.toObjectId)(categoryId) });
            return true;
        });
    }
